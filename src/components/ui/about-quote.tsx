        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы верим, что анимация будущего рождается на пересечении технологий и воображения. Наши мультики — это не просто видео: это эксперимент, где нейросеть становится режиссёром, художником и сценаристом одновременно.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Ребёнок, открывающий новые миры, или взрослый, ищущий что-то необычное — наш AI-мультик станет для вас окном в истории, которых раньше не существовало.
            </p>
          </div>
        </div>
      </div>

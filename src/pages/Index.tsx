      ...
      >
          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center px-0 leading-5">
              <h1 className="mb-8 text-balance text-5xl tracking-tight text-white [text-shadow:_0_4px_20px_rgb(0_0_0_/_60%)] md:text-6xl lg:text-8xl">
                <span className="font-open-sans-custom not-italic">Мультики.</span>{" "}
                <span className="font-serif italic">Созданные.</span>{" "}
                <span className="font-open-sans-custom not-italic">ИИ.</span>
              </h1>
              ...
              <p className="mb-8 mx-auto max-w-2xl text-pretty leading-relaxed text-gray-300 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-thin font-open-sans-custom tracking-wide leading-7 text-xl">
                уникальные анимированные истории, рождённые искусственным интеллектом —
                смотри,{" "}
                <span className="font-serif italic">удивляйся</span> и погружайся в новый мир
              </p>

              <div className="flex justify-center">
                <ShinyButton className="px-8 py-3 text-base">смотреть</ShinyButton>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Выберите удобный план. От разового просмотра до безлимитного доступа ко всей
                коллекции AI мультиков.
              </p>
            </div>
            <BentoPricing />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Как мы создаём анимацию нового поколения с помощью искусственного интеллекта.
              </p>
            </div>
            <AboutQuote />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl mt-[5vh]">
            <ContactCard
              title="Написать нам"
              description="Есть вопросы, идеи или хотите сотрудничество? Заполните форму — мы отвечаем в течение 1 рабочего дня."
              contactInfo={[
                {
                  icon: MailIcon,
                  label: "Почта",
                  value: "hello@aimultik.ru",
                },
                {
                  icon: PhoneIcon,
                  label: "Телефон",
